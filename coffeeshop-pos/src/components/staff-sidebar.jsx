...
import { ClipboardList, Coffee, LogOut, Menu, ShoppingCart, TableProperties, X } from "lucide-react"
          ...
          <div className="space-y-4 py-4">
            <div className="px-3 py-2">
              <div className="mb-2 flex items-center justify-between">
                <Link to="/staff" className="flex items-center gap-2 px-2">
                  <Coffee className="h-6 w-6" />
                  <h2 className="text-lg font-semibold">POS Nhân viên</h2>
                </Link>
